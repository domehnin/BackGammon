...
public class Dice
{
    ...
    public static final int maxMovesCount = 4; /* Bonus for getting doubles. Would be diff with more dice. */
    public static final int NO_SUCH_DIE = -9; /* if someone asks unrolled dice which one is highest roll */
     ...
     */
    public static boolean legitDiceValue(int dieVal) {
     ...
     */
    public static boolean legitDieNum(int dieNum) {

...
import model.BadBoardException;
import model.BadMoveException;
import model.Dice;
...
public class Board {
    ...
    public int white_bar = 0; /* how many blots on white's bar */
    public int black_bar = 0;
    public int white_bear = 0; /* how many blots white has "beared off" the board */
    public int black_bear = 0;

    public Dice myDice = new Dice( ); /* this should be private but then re-edit */
     ...
     */
    public ArrayList<PartialMove> allLegalPartialMoves( int playerColor /*, Game myGame*/) 
     ...
     */
    public void doPartialMove(PartialMove pm) {
        if (pm == null) {
     ...
     */
    public void doPartialMove(int fromPoint, int toPoint, int whichDie, int playerColor) {
